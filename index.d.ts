...
* });
*
* var z = sgemv( [ A, x, y, trans, alpha, beta ] );
* // returns <ndarray>[ 18.0, 37.0 ]
*
* var bool = ( z === y );
* // returns true
*/
declare function sgemv( arrays: [ float32ndarray, float32ndarray, float32ndarray, ndarray, float32ndarray, float32ndarray ] ): float32ndarray;
